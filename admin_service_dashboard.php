...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div><label>Branch:</label><input type="radio"name="branch" value="OTHER"/>OTHER<input type="radio" name="branch" value="CSE"/>CSE<div style="margin-left:80px"><input type="radio" name="branch" value="CIVIL"/>CIVIL<input type="radio" name="branch" value="ELECTRICAL"/>ELECTRICAL</div>
            </div>   
